...
import com.example.sirajudin12rpl02.activity.admin.AdminSepedaCreateActivity;
import com.example.sirajudin12rpl02.adapter.AdminSepedaAdapter;
import com.example.sirajudin12rpl02.adapter.SepedaAdapter;
...
public class SepedaActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void binding() {
        ...
        rv = findViewById(R.id.rvSepedaUser);
        ...
        AndroidNetworking.post(Config.BASE_URL_API + "unitfrontend.php")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onError(ANError anError) {
                        swipeRefresh.setRefreshing(false);
                        Toast.makeText(SepedaActivity.this, Config.TOAST_AN_EROR, Toast.LENGTH_SHORT).show();
